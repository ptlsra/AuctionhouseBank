$(document).ready(function(){
	...
	var ipfsPort=ipfsPortNo();
		...
		var impAdd=[];
		 ...
		 $.get("http://"+ipAdd+":"+port+"/getAllBanks", function(response){
			...
			var exporterBank=impAdd[0];
			  ...
			  $.get("http://"+ipAdd+":"+port+"/getAllowance?ownerAddress="+importerBank+"&spenderAddress="+exporterBank, function(responseDataNewValueTwoNew){
					 // alert(JSON.stringify(response));
		  ...
		  $.get("http://"+ipAdd+":"+port+"/getAllExporters", function(responseDataNewValueTwoNew){
				 // alert(JSON.stringify(response));
		  ...
		  $.get("http://"+ipAdd+":"+port+"/getAllImporters", function(responseDataNewValueTwoNew){
				 // alert(JSON.stringify(response));
